...
$host = 'sqlXXX.infinityfree.com';  // Remplace XXX par ton numéro
$dbname = 'if0_XXXXXXX';           // Remplace XXXXXXX par ton nom de base
$username = 'if0_XXXXXXX';         // Remplace XXXXXXX par ton nom d'utilisateur
